...
internal class Problem_8 : ProblemBase
{
    ...
    private int count;
    private string series = "73167176531330624919225119674426574742355349194934"+
    ...
    public override void Solve()
    {
        ...
        {
            long product = series[i] - 48;
            for (int j=1;j<count;j++) product*= series[i+j] - 48;;
    ...
    public override void DisplayResult()
    {
        ...
        Console.WriteLine("\r\nThe greatest product is: " + result);
